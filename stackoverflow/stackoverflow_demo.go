...
func Run() {
	...
	if err := system.Vote(charlie, javaQuestion, 1); err != nil {
		fmt.Printf("Error voting on question: %v\n", err)
		return
	}
	if err := system.Vote(charlie, bobAnswer, 1); err != nil {
	...
	if err := system.Vote(charlie, pythonQuestion, 1); err != nil {
		fmt.Printf("Error voting on Python question: %v\n", err)
		return
	}
	if err := system.Vote(charlie, aliceAnswer, 1); err != nil {
